...
<div id="article">
 <div id="article_image_frame">
  {literal}
  <img src="http://farm5.static.flickr.com/4028/4298034064_db789233e1.jpg" onload="elation.zoom.replace('article_image_frame', {size: [11057, 8630], tilesize: 256, overlap: 1, url: '/images/deepzoom/buttermilkcreek_files/{level}/{column}_{row}.jpg'})" />
{/literal}
 </div>
